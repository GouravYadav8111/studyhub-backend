...
router.post("/razorpay", express.raw({ type: 'application/json' }), async (req, res) => {
  try {
    ...
    const secret = process.env.RAZORPAY_WEBHOOK_SECRET; // You will generate this in the Razorpay Dashboard
    ...
    // 4. Handle the specific lifecycle events
    if (event.event === "subscription.charged") {
      ...
      // Calculate the 24-hour Grace Period exactly as requested
